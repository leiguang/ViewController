//
//  ContinuousPresentingViewController.swift
//  ViewController
//
...
let kNotificationDismiss = "kNotificationDismiss"

class ContinuousPresentingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(receiveNotificationDismiss), name: NSNotification.Name(rawValue: kNotificationDismiss), object: nil)
        
    
        let presentButton = UIButton(frame: CGRect(x: 100, y: 300, width: 150, height: 100))
    ...
    @objc func receiveNotificationDismiss() {
