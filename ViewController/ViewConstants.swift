...
let kTabBarHeight: CGFloat = (UIScreen.main.bounds.width == 812 || UIScreen.main.bounds.height == 812) ? (49.0 + 34.0) : 49.0

/// 顶部安全区域距离 （非iPhone X：20； iPhone X：44pt，同导航栏高度）
let kSafeAreaTop: CGFloat = (UIScreen.main.bounds.width == 812 || UIScreen.main.bounds.height == 812) ? 44.0 : 20.0

/// 底部安全区域 距离 （非iPhone X：0pt； iPhone X：34pt）
let kSafeAreaBottom: CGFloat = (UIScreen.main.bounds.width == 812 || UIScreen.main.bounds.height == 812) ? 34.0 : 0.0
